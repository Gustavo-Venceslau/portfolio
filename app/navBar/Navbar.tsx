    ...
    return(
        <nav className="w-full h-20 flex justify-between items-center px-20">
            ...
            <ul className="flex flex-row list-none text-white text-lg">
                ...
                <li className="ml-16 hover:border-b-2 hover:border-[#2b4c7e]"><a>Works</a></li>
                <li className="ml-16 hover:border-b-2 hover:border-[#2b4c7e]"><a href='#Projects'>Projects</a></li>
            </ul>
